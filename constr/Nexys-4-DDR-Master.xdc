...
#set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { RTS }]; #IO_L20N_T3_A19_15 Sch=ja[1]
#set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { TXD }]; #IO_L21N_T3_DQS_A18_15 Sch=ja[2]
#set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { RXD }]; #IO_L21P_T3_DQS_15 Sch=ja[3]
#set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { CTS }]; #IO_L18N_T2_A23_15 Sch=ja[4]
...
set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { debug_tx }]; #IO_L17P_T2_35 Sch=jd[2]
set_property -dict { PACKAGE_PIN G1    IOSTANDARD LVCMOS33 } [get_ports { debug_rx }]; #IO_L17N_T2_35 Sch=jd[3]
...
# set_property -dict {PACKAGE_PIN C4 IOSTANDARD LVCMOS33} [get_ports debug_rx]
# set_property -dict {PACKAGE_PIN D4 IOSTANDARD LVCMOS33} [get_ports debug_tx]
#set_property -dict { PACKAGE_PIN D3    IOSTANDARD LVCMOS33 } [get_ports { CTS0 }]; #IO_L12N_T1_MRCC_35 Sch=uart_cts
#set_property -dict { PACKAGE_PIN E5    IOSTANDARD LVCMOS33 } [get_ports { RTS0 }]; #IO_L5N_T0_AD13N_35 Sch=uart_rts
