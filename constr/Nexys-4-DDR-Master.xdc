...
set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { RX1_O }]; #IO_L17P_T2_35 Sch=jd[2]
set_property -dict { PACKAGE_PIN G1    IOSTANDARD LVCMOS33 } [get_ports { TX1_I }]; #IO_L17N_T2_35 Sch=jd[3]
...
set_property -dict {PACKAGE_PIN C4 IOSTANDARD LVCMOS33} [get_ports RX0_I]
set_property -dict {PACKAGE_PIN D4 IOSTANDARD LVCMOS33} [get_ports TX0_O]
